...
DATABASES = {
       'default': dj_database_url.config(default='postgres://ariakon_user:KQQ@;c"T=3XU,5W@ariakon.postgres.database.azure.com:5432/postgres', conn_max_age=600, ssl_require=True)
}
