...
class AudioFileTests(TestCase):
    ...
    def create_test_audio_file(self):
        ...
        return SimpleUploadedFile("test_audio.wav", audio_data.read(), content_type="audio/wav")
    ...
    def test_get_audio_file_list(self):
        ...
        self.client.post(AUDIO_FILE_URL, {
            "file": self.create_test_audio_file(),
            "distance": 10.0,
        })
        self.client.post(AUDIO_FILE_URL, {
    ...
    def test_retrieve_audio_file_detail(self):
        ...
        audio_file_response = self.client.post(AUDIO_FILE_URL, {
            "file": self.create_test_audio_file(),
            "distance": 10.0,
        })
